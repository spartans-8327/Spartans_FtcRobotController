package org.firstinspires.ftc.teamcode.test.vuforia;
...
public class Robot_Navigation
{
     ...
     */
    public void initVuforia(LinearOpMode opMode, Robot_OmniDrive robot , HardwareMap hardwareMap) {
         ...
         */
        targets = vuforia.loadTrackablesFromAsset("PruebaVuforia");
        targets.get(0).setName("NocheEstrellada");
        targets.get(1).setName("Kakaroto");
        targets.get(2).setName("MasterChef");
        targets.get(3).setName("Bigboss");
